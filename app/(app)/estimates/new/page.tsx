      ...
      <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-8">
        ...
        {state === "idle" && (
          <div className="flex flex-col items-center gap-6 py-8">
            ...
            <button
              ...
              className="w-24 h-24 rounded-full bg-[#F97316] hover:bg-[#ea6c0a] text-white shadow-lg hover:shadow-xl transition-all flex items-center justify-center"
        ...
        {state === "transcribing" && (
          <div className="flex flex-col items-center gap-4 py-12">
            <div className="w-10 h-10 border-2 border-[#F97316] border-t-transparent rounded-full spinner" />
          ...
          <div className="space-y-6">
            <div>
              ...
              <textarea
                ...
                rows={8}
                className="w-full px-3 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-[#F97316]/30 focus:border-[#F97316] resize-none"
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 h-10 text-sm font-medium bg-[#F97316] hover:bg-[#ea6c0a] disabled:opacity-50 text-white rounded-xl transition-colors"
              >
                Generate Estimate
              </button>
            </div>
        ...
        {state === "error" && (
          <div className="space-y-4">
            ...
            <button
              ...
              className="h-10 px-6 text-sm font-medium bg-[#F97316] hover:bg-[#ea6c0a] text-white rounded-xl transition-colors"
            >
              Try again
            </button>
          </div>
