      ...
      await fetch("https://api.resend.com/emails", {
        ...
        body: JSON.stringify({
          ...
          html: `
            ...
            <p><a href="${clientUrl}" style="display:inline-block;padding:12px 24px;background:#F97316;color:white;border-radius:8px;text-decoration:none;font-weight:600;">View Estimate</a></p>
